...
class CoulombConvolver(numrec.QuickConvolver):
    def __init__(self,xs,ys,kernel_func_fourier=unscreened_coulomb_kernel_fourier,bc='open'):
...
class TipResponse:
    ...
    def _SetEigenbasisTranslators(self,xs,ys):
        ...
        for n in range(N):
            tip_eb.append(Translator(xs=xs,ys=ys,f=self.func(self.q,n,N,xs,ys)))
        return tip_eb
